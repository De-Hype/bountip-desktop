...
// import { useUpdateInvoiceSettingsMutation } from "@/redux/outlets";
...
//     const settings = outlet?.invoiceSettings;
//     setFormData({
...
//       return validSizes.includes(paperSize as any) ? (paperSize as any) : "A4";
//     };
...
//       onError(
//         "Update Failed",
//         error.message || "An error occurred while updating invoice settings"
//       );
//     } finally {
//       setIsLoading(false);
//     }
