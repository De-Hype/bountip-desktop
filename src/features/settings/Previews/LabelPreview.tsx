...
interface LabelPreviewFormDataLabelItem {
  name: string;
  enabled: boolean;
}

interface LabelPreviewFormData {
  showBakeryName?: boolean;
  showBakeyName?: boolean;
  ...
  selectedColumns?: LabelPreviewFormDataSelectedColumns;
  ...
  showBarcode?: boolean;
  labelItems?: LabelPreviewFormDataLabelItem[];
  showOrderName?: boolean;
}

interface LabelPreviewProps {
  formData: LabelPreviewFormData;
    ...
    >
      ...
      <div className="border-t border-gray-200 pt-4 mb-4">
        <div className="grid grid-cols-5 gap-2 text-xs text-gray-500 font-medium mb-3">
          {(getNestedValue(formData, "selectedColumns.orderName") as boolean) ||
          formData.showOrderName ? (
            <span>Order</span>
          ) : null}
          {getNestedValue(formData, "selectedColumns.sku") ? (
            <span>SKU</span>
          ) : null}
          {getNestedValue(formData, "selectedColumns.qty") ? (
            <span>Qty</span>
          ) : null}
