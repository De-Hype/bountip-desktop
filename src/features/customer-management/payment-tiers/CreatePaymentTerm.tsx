...
const CreatePaymentTerm = ({
  ...
  return (
    <Modal
      ...
      subtitle="Configure your payment term below"
      size="sm"
    >
      <div className="space-y-6 w-full px-1">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#15BA5C] focus:border-transparent transition-all"
          />
        </div>
